    ...
    <body>
        ...
        <script>
            ...
            function renderTabelPenjualan() {
                ...
                dataPenjualan.forEach((item, index) => {
                    ...
                    tr.innerHTML = `
                        ...
                        <td>${item.satuan3 || ''}</td>
                        <td style="text-align: right;">${parseInt(item.harga).toLocaleString('id-ID')}</td>
            ...
            document.getElementById('btnPrint').addEventListener('click', () => {
                ...
                const url = `notaprintpem.php?nonota=${encodeURIComponent(noNota)}&from=editpenjualan.php`;
