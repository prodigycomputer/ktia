...
<main>
  ...
  <div class="search-bar">
      <input type="text" id="searchKode" class="search-kode" placeholder="Kode Area" oninput="handleInput('kode')" style="text-transform: uppercase;">
      <input type="text" id="searchNama" class="search-nama" placeholder="Nama Area" oninput="handleInput('nama')" style="text-transform: uppercase;">
      <button type="button" id="searchbtn" onclick="triggerSearch()">🔍 Cari</button>
  </div>

  <form id="areaForm" action="prosesarea.php" enctype="multipart/form-data" onsubmit="return false;">
    <input type="hidden" name="aksi" id="aksi" value="">
    <input type="hidden" name="kodearea_lama" id="kodearea_lama" value="">
    ...
    <div class="form-atas">
      ...
      <input type="text" name="namaarea" id="namaarea" class="verylong-input" required style="text-transform: uppercase;">
    </div>
...
<script>
      ...
      function initializeFormButtonsCancel() {
          ...
          document.getElementById('namaarea').value = previousFormData.namaarea;
          ...
          document.getElementById('namaarea').disabled = true;
      ...
      function initializeTambah() {
        ...
        document.getElementById('kodearea').readOnly = false;
        document.getElementById('namaarea').disabled = false;
      ...
      function cancelForm() {
        ...
        kodeInput.value = '';
        namaInput.value = '';
        document.getElementById('kodearea').readOnly = true;
        document.getElementById('searchbtn').disabled = false;
      ...
      previousFormData = {
        ...
        kodearea_lama: document.getElementById('kodearea_lama').value
      };
      ...
      forceUppercase('kodearea');
      forceUppercase('namaarea');
      ...
      function showFilterPopup(dataList) {
          ...
          const fixedFields = ['kodearea', 'namaarea'];
      ...
      function triggerSearch() {
          ...
          fetch(`filter_area.php?keyword=${encodeURIComponent(keyword)}`)
      ...
      function pilihArea(data) {
          document.getElementById('kodearea').value = data.kodearea;
          document.getElementById('kodearea_lama').value = data.kodearea; 
          document.getElementById('namaarea').value = data.namaarea;
        ...
        .then(response => {
          if (response.status === 'success') {
            ...
            previousFormData = {
              ...
              namaarea: document.getElementById('namaarea').value.trim(),
              kodearea_lama: document.getElementById('kodearea').value.trim()
            };
            ...
            showToast('Kode area sudah ada!', '#dc3545');
          } else {
