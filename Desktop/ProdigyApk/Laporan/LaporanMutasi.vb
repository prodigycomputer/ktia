...
Public Class LaporanMutasi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProdigyProject.LaporanMutasi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanMutasi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanMutasi = New LaporanMutasi()
        rpt.Site = Me.Site
        Return rpt
    End Function
