...
Public Class LaporanRinciMutasi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProdigyProject.LaporanRinciMutasi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanRinciMutasi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanRinciMutasi = New LaporanRinciMutasi()
        rpt.Site = Me.Site
        Return rpt
    End Function
