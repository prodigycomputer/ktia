...
Public Class NotaPenyesuaian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProdigyProject.NotaPenyesuaian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaPenyesuaian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaPenyesuaian = New NotaPenyesuaian()
        rpt.Site = Me.Site
        Return rpt
    End Function
