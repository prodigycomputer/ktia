...
Public Class FPenyesuaian
    ...
    Private Sub btnSIMPAN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSIMPAN.Click
        Try
            ...
            BukaKoneksi()
            Dim sqlCek As String = "SELECT COUNT(*) FROM zpenyesuaian WHERE nonota = ?"
            ...
            ElseIf (Not exists AndAlso status = "tambah") OrElse (exists AndAlso status = "ubah") Then
                ...
                SimpanPenyesuaian(nomor, dict, status)

                MessageBox.Show("Data Penyesuaian berhasil disimpan untuk " & aktifTab.Text, "Sukses")
