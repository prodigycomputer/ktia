...
Public Class LaporanRekapRJual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProdigyProject.LaporanRekapRJual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanRekapRJual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanRekapRJual = New LaporanRekapRJual()
        rpt.Site = Me.Site
        Return rpt
    End Function
