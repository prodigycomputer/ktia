...
Public Class FLaporanReturPembelian
    ...
    Private Sub btnPRINT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPRINT.Click
        Try
            ...
            If cbREKAP.Checked Then
                jenisLaporan = "laporanrekaprbeli"
                sql = "SELECT nonota FROM zrbeli" ' Ambil salah satu (atau bisa sesuaikan filter)
            ElseIf cbRINCI.Checked Then
                jenisLaporan = "laporanrincirbeli"
                sql = "SELECT nonota FROM zrbelim"
            End If
            ...
            f.Param("kodesup1") = txtLKDSUP1.Text.Trim()
            f.Param("kodesup2") = txtLKDSUP2.Text.Trim()
