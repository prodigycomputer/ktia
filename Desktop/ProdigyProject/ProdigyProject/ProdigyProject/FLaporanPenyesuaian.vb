    ...
    Private Sub btnPRINT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPRINT.Click
        Try
            ...
            If cbREKAP.Checked Then
                jenisLaporan = "laporanrekappenyesuaian"
                sql = "SELECT nonota FROM zpenyesuaian" ' Ambil salah satu (atau bisa sesuaikan filter)
            ElseIf cbRINCI.Checked Then
                jenisLaporan = "laporanrincipenyesuaian"
                sql = "SELECT nonota FROM zpenyesuaianm"
            End If
            ...
            f.Param("kodegd1") = txtLKDGD1.Text.Trim()
            f.Param("kodegd2") = txtLKDGD2.Text.Trim()
