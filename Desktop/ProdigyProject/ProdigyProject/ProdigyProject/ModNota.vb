...
Module ModNota
    ...
    Public Sub LoadNota(ByVal jenis As String, ByVal nonota As String, ByVal viewer As CrystalDecisions.Windows.Forms.CrystalReportViewer)
        Try
            ...
            Select Case jenis.ToLower()
                Case "pembelian"
                    rpt.Load(Application.StartupPath & "\Nota\NotaPembelian.rpt")
                Case "rpembelian"
                    rpt.Load(Application.StartupPath & "\Nota\NotaReturPembelian.rpt")
                Case "penjualan"
                    rpt.Load(Application.StartupPath & "\Nota\NotaPenjualan.rpt")
                Case "rpenjualan"
                    rpt.Load(Application.StartupPath & "\Nota\NotaReturPenjualan.rpt")
                Case "mutasi"
                    rpt.Load(Application.StartupPath & "\Nota\NotaMutasi.rpt")
                Case "penyesuaian"
                    rpt.Load(Application.StartupPath & "\Nota\NotaPenyesuaian.rpt")
            End Select
