...
Public Class FLaporanReturPenjualan

    Private Sub FLaporanReturPenjualan_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnPRINT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPRINT.Click
        Try
            ...
            If cbREKAP.Checked Then
                jenisLaporan = "laporanrekaprjual"
                sql = "SELECT nonota FROM zrjual" ' Ambil salah satu (atau bisa sesuaikan filter)
            ElseIf cbRINCI.Checked Then
                jenisLaporan = "laporanrincirjual"
                sql = "SELECT nonota FROM zrjualm"
            End If
