    ...
    Private Sub btnPRINT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPRINT.Click
        Try
            ...
            If cbREKAP.Checked Then
                jenisLaporan = "laporanrekapmutasi"
                sql = "SELECT nonota FROM zmutasi" ' Ambil salah satu (atau bisa sesuaikan filter)
            ElseIf cbRINCI.Checked Then
                jenisLaporan = "laporanrincimutasi"
                sql = "SELECT nonota FROM zmutasim"
            End If
