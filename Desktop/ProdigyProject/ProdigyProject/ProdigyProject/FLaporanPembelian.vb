    ...
    Private Sub btnPRINT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPRINT.Click
        Try
            ...
            If cbREKAP.Checked Then
                jenisLaporan = "laporanrekapbeli"
                sql = "SELECT nonota FROM zbeli" ' Ambil salah satu (atau bisa sesuaikan filter)
            ElseIf cbRINCI.Checked Then
                jenisLaporan = "laporanrincibeli"
                sql = "SELECT nonota FROM zbelim"
            End If
