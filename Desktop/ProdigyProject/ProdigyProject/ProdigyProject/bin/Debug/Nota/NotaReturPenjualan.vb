...
Public Class NotaReturPenjualan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProdigyProject.NotaReturPenjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaReturPenjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaReturPenjualan = New NotaReturPenjualan()
        rpt.Site = Me.Site
        Return rpt
    End Function
