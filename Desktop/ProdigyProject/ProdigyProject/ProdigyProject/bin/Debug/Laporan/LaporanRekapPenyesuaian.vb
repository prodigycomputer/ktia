...
Public Class LaporanPenyesuaian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProdigyProject.LaporanPenyesuaian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanPenyesuaian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanPenyesuaian = New LaporanPenyesuaian()
        rpt.Site = Me.Site
        Return rpt
    End Function
