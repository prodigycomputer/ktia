...
Public Class LaporanRekapRBeli
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProdigyProject.LaporanRekapRBeli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanRekapRBeli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanRekapRBeli = New LaporanRekapRBeli()
        rpt.Site = Me.Site
        Return rpt
    End Function
