...
Public Class LaporanRinciRJual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProdigyProject.LaporanRinciRJual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanRinciRJual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanRinciRJual = New LaporanRinciRJual()
        rpt.Site = Me.Site
        Return rpt
    End Function
