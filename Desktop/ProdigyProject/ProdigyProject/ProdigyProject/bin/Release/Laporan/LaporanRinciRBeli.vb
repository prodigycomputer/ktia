...
Public Class LaporanRinciRBeli
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProdigyProject.LaporanRinciRBeli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanRinciRBeli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanRinciRBeli = New LaporanRinciRBeli()
        rpt.Site = Me.Site
        Return rpt
    End Function
