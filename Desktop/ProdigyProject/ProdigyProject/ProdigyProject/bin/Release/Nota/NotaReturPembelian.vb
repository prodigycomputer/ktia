...
Public Class NotaReturPembelian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProdigyProject.NotaReturPembelian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaReturPembelian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaReturPembelian = New NotaReturPembelian()
        rpt.Site = Me.Site
        Return rpt
    End Function
