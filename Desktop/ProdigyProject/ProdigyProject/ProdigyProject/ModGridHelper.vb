Module ModGridHelper
    ...
    ' === Setup untuk Grid Pembelian (zbeli) ===
    Public Sub SetupGridLBeli(ByVal grid As DataGridView)
        With grid
            .AllowUserToAddRows = False
            .AllowUserToDeleteRows = False
            .AllowUserToResizeRows = False   ' <<< baris tidak bisa di-resize
            ...
            .Columns.Add("tgltempo", "Tanggal Tempo")
            .Columns("tgltempo").Width = 150
    ...
    Public Sub SetupGridLJual(ByVal grid As DataGridView)
        With grid
            .AllowUserToAddRows = False
            .AllowUserToDeleteRows = False
            .AllowUserToResizeRows = False   ' <<< baris tidak bisa di-resize
