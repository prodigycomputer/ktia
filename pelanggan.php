...
<body>
    ...
    <main>
        <h2>Data Kustomer</h2>
            ...
            <form id="kustForm" action="proseskustomer.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <div class="form-atas">
                    ...
                    <label for="namakust">Nama Barang</label>
                    ...
                    <input type="text" step="0.01" name="kota" id="kota" class="medium-input" required oninput="checkIsi1()" >
    ...
    <script>
        ...
        function initializeUbah() {
            ...
            document.getElementById('searchNama').value = '';
            document.getElementById('searchbtn').disabled = true;
            const kota = parseFloat(document.getElementById('kota').value);
        ...
        function showFilterPopup(dataList) {
            ...
            const fixedFields = ['kodekust', 'namakust', 'alamat', 'kota', 'satuan2', 'isi2', 'satuan3'];
        ...
        function pilihBarang(data) {
            ...
            // Logika enable/disable berdasarkan kota dan isi2
            document.getElementById('btnTambah').disabled = true;
            ...
            const kodekust = data.kodekust;
            const kodegrupList = <?= json_encode($kodegrupList) ?>;

            const matchedGrup = kodegrupList.find(grup => kodekust.startsWith(grup));
        ...
        function cancelEdit() {
            document.getElementById('kustForm').reset();
            initializeFormButtons();
        ...
        document.getElementById('kustForm').addEventListener('submit', function () {
