...
<main>
  ...
  <div class="search-bar">
      <input type="text" id="searchKode" class="search-kode" placeholder="Kode Tipe" oninput="handleInput('kode')" style="text-transform: uppercase;">
      <input type="text" id="searchNama" class="search-nama" placeholder="Nama Tipe" oninput="handleInput('nama')" style="text-transform: uppercase;">
      <button type="button" id="searchbtn" onclick="triggerSearch()">🔍 Cari</button>
  </div>

  <form id="tipeForm" action="prosestipe.php" enctype="multipart/form-data" onsubmit="return false;">
    <input type="hidden" name="aksi" id="aksi" value="">
    <input type="hidden" name="kodetipe_lama" id="kodetipe_lama" value="">
    ...
    <div class="form-atas">
      ...
      <input type="text" name="namatipe" id="namatipe" class="verylong-input" required style="text-transform: uppercase;">
    </div>
...
<script>
      ...
      function initializeFormButtonsCancel() {
          ...
          document.getElementById('namatipe').value = previousFormData.namatipe;
          ...
          document.getElementById('namatipe').disabled = true;
      ...
      function initializeTambah() {
        ...
        document.getElementById('tipeForm').reset();
        ...
        document.getElementById('kodetipe').readOnly = false;
        document.getElementById('namatipe').disabled = false;
      ...
      function cancelForm() {
        ...
        kodeInput.value = '';
        namaInput.value = '';
        document.getElementById('kodetipe').readOnly = true;
        document.getElementById('searchbtn').disabled = false;
      ...
      previousFormData = {
        ...
        kodetipe_lama: document.getElementById('kodetipe_lama').value
      };
      ...
      forceUppercase('kodetipe');
      forceUppercase('namatipe');
      ...
      function showFilterPopup(dataList) {
          ...
          const fixedFields = ['kodetipe', 'namatipe'];
      ...
      function triggerSearch() {
          ...
          fetch(`filter_tipe.php?keyword=${encodeURIComponent(keyword)}`)
      ...
      function pilihTipe(data) {
          document.getElementById('kodetipe').value = data.kodetipe;
          document.getElementById('kodetipe_lama').value = data.kodetipe; 
          document.getElementById('namatipe').value = data.namatipe;
      ...
      document.getElementById('tipeForm').addEventListener('submit', function (e) {
        e.preventDefault();

        const formData = new FormData(this);
        formData.set('aksi', currentstat); // 'tambah', 'update', 'hapus'

        fetch('prosestipe.php', {
          method: 'POST',
          body: formData
        })
        .then(res => res.json())
        .then(response => {
          if (response.status === 'success') {
            ...
            previousFormData = {
              ...
              namatipe: document.getElementById('namatipe').value.trim(),
              kodetipe_lama: document.getElementById('kodetipe').value.trim()
            };
            ...
            showToast('Kode tipe sudah ada!', '#dc3545');
          } else {
      ...
      function konfirmasiHapus(setuju) {
          ...
          if (setuju) {
              const formData = new FormData(document.getElementById('tipeForm'));
