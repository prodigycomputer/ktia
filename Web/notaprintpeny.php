...
$q = mysqli_query($conn, "SELECT qbrspenyesuaian FROM zconfig LIMIT 1");
$row = mysqli_fetch_assoc($q);
$maxPerPage = (int)$row['qbrspenyesuaian'];
...
<script>
    ...
    fetch(`getpenyesuaian.php?nonota=${encodeURIComponent(noNota)}`)
    .then(res => res.json())
    .then(data => {
            ...
            container.innerHTML = `
                ...
                <div class="form-header">
                    ...
                    <div class="form-kanan">
                        <div class="field"><label>Kode Gudang</label><label>:</label><span>${h.kodegd} ${h.namagd}</span></div>
                    </div>
                </div>
